...
##Pmod Header JB for Artix 7 DDR Board
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports { spi_dc }]; # Sch=jb[1]
set_property -dict { PACKAGE_PIN F16 IOSTANDARD LVCMOS33 } [get_ports { io0_o }]; # Sch=jb[2]
set_property -dict { PACKAGE_PIN G16 IOSTANDARD LVCMOS33 } [get_ports { sck_o }]; # Sch=jb[3]
set_property -dict { PACKAGE_PIN H14 IOSTANDARD LVCMOS33 } [get_ports { ss_o }]; # Sch=jb[4]
set_property -dict { PACKAGE_PIN E16 IOSTANDARD LVCMOS33 } [get_ports { reset_spi }];# Sch=jb[7]
